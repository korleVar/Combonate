<!-- сценарий действтий в исключительной ситуаци -->
<?php
...
try {
    // этап начальной загрузки инициализации
    ...
    // продолжить выполнение этапа начальной загрузки
} catch (ConfigFileNotFoundException $e) {
    echo "ConfigFileNotFoundException: ";
    // дополнение
    die();
} catch (Exception $e) {
    echo $e->getMessage();
